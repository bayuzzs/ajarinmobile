...
@Composable
fun QuizChampionScreen(navController: NavController) {
    Scaffold(
        bottomBar = {AjarinBottomBar(navController = navController)},
        containerColor = Color.White
    ) { innerPadding ->
//        Text("Quiz Champion Screen", modifier = Modifier.padding(innerPadding))
        Image(
            painter = painterResource(R.drawable.quiz_champion_placeholder),
